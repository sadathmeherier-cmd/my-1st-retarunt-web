...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex w-14 h-14 items-center justify-center rounded-full bg-[#25d366] text-black shadow-lg shadow-[#25d366]/30 transition-transform duration-300 group-hover:scale-110">
        <svg
          viewBox="0 0 32 32"
      ...
      <span
        className={`pointer-events-none absolute right-16 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-full glass-strong px-4 py-2 text-xs text-foreground/80 transition-all duration-300 ${
